...
export default function MenuDetailsClient({ menuItem }: MenuDetailsClientProps) {
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center border rounded-lg">
              ...
              <button onClick={() => handleQuantityChange(1)} className="px-3 py-1 hover:bg-gray-100 transition-colors">
                +
              </button>
            </div>
          </div>
